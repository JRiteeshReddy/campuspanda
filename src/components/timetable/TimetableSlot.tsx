...
const TimetableSlot: React.FC<TimetableSlotProps> = ({ entry, subjectName, location }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col p-1 cursor-pointer hover:bg-primary/5 transition-colors bg-primary/10 dark:bg-primary/20">
      <span className="font-medium text-xs truncate">{subjectName}</span>
